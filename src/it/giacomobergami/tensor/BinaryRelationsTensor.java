 ...
 * @author gyankos
 */
public class BinaryRelationsTensor extends Tensor<GuavaBinaryTensorLayer> {

    public BinaryRelationsTensor() {
        super(GuavaBinaryTensorLayer.class);
    }
